      ...
      <ScrollableView>
        <View style={styles.container}>
          ...
          <View style={styles.menue}>
            <TouchableOpacity
              onPress={() => setselect(0)}
              style={select === 0 ? styles.selected : null}>
              <Text
                style={select === 0 ? styles.menutext : styles.unselecttext}>
                Post
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => setselect(1)}
              style={select === 1 ? styles.selected : null}>
              <Text
                style={select === 1 ? styles.menutext : styles.unselecttext}>
                Discussion
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => setselect(2)}
              style={select === 2 ? styles.selected : null}>
              <Text
                style={select === 2 ? styles.menutext : styles.unselecttext}>
                Trendng
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => ShowFilter()}
              style={select === 3 ? styles.selected : null}>
              <Text
                style={select === 3 ? styles.menutext : styles.unselecttext}>
                Filter
              </Text>
            </TouchableOpacity>
          </View>
