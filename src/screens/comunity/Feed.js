        ...
        return (
            <View>
                ...
                <View style={styles.container}>
                    <Text style={styles.desc} numberOfLines={numOfLines == 0 ? null : loadMore ? numOfLines : 2}
                    ...
                    {(numOfLines > 2) &&
                        ...
                        <TouchableOpacity style={[styles.row, { marginTop: -10 }]} onPress={onLoadMoreToggle}>
                            <Text style={styles.ReadMore}>{loadMore ? 'Read Less' : 'Read More'}  </Text>
                            <ReadMore />
                        </TouchableOpacity>
                ...
                <View style={[styles.row, { padding: 10, justifyContent: 'space-between', marginTop: -5 }]}>
